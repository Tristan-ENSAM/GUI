...
# Run the solver. We don't call writeInput separately because submit()
# writes the .inp itself before launching the analysis. Leave
# writeInput() commented for when you want only the .inp (dry test of
# the geometry/material assembly without spending solver time).
# myJob.writeInput()
